...
public class Main
{
    ...
    {
//        Book book1 = new Book("test", "Me", "Scary");
//        Book book2 = new Book("Alice in Wonderland", "JK Rowling", "Fantasy");
//        Book book3 = new Book("Harry Potter 1", "JK Rowling", "Magic");
//        Book book4 = new Book("Of Mice And Men", "Ormwell", "Fiction");
...
//        lib.printBooks();
//        Book testBook = new Book("ABC", "Dr Seuss", "Kids");
//        lib.checkout(book2);
